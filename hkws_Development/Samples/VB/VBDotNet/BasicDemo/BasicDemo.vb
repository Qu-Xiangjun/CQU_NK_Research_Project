...
Public Class BasicDemo
    ...
    Sub ReceiveThreadProcess()
        ...
        While (m_bIsGrabbing)
            Dim nRet = dev.MV_CC_GetImageBuffer_NET(stFrameOut, 1000)
            If MyCamera.MV_OK = nRet Then
                ...
                If True = RemoveCustomPixelFormats(stFrameOut.stFrameInfo.enPixelType) Then
    ...
    Private Sub ButtonSaveBmp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSaveBmp.Click
        ...
        stSaveImageParam.pImagePath = "Image_w" + stSaveImageParam.nWidth.ToString() + "_h" + stSaveImageParam.nHeight.ToString() + "_fn" + m_stFrameInfo.nFrameNum.ToString() + ".bmp"
    ...
    Private Sub ButtonSaveJpg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSaveJpg.Click
        ...
        stSaveImageParam.pImagePath = "Image_w" + stSaveImageParam.nWidth.ToString() + "_h" + stSaveImageParam.nHeight.ToString() + "_fn" + m_stFrameInfo.nFrameNum.ToString() + ".jpg"
        nRet = dev.MV_CC_SaveImageToFile_NET(stSaveImageParam)
        If (MyCamera.MV_OK <> nRet) Then
            m_ReadWriteLock.ReleaseWriterLock() ' 释放写入锁定
            MsgBox("Save Image fail!")
